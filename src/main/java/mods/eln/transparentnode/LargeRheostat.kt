...
import mods.eln.sixnode.resistor.ResistorGui
...
class LargeRheostatGUI(player: EntityPlayer, inventory: IInventory, internal var render: LargeRheostatRender) :
    ...
    override fun postDraw(f: Float, x: Int, y: Int) {
        helper.drawString(8, 12, -16777216, "Resistance : " + Utils.plotValue(render.desc.getRsValue(render.inventory), "Ohm"))
